...
import { RepeatedPasswordProp } from "./repeatedPass.type";

export function RepeatedPassChart(props: RepeatedPasswordProp) {
    ...
    <Card className="flex flex-col">
      ...
      <CardFooter className="flex-col gap-2 text-sm">
        <div className="flex items-center gap-2 font-medium leading-none">
          Try to have the same password <TrendingUp className="h-4 w-4" />
        </div>
        <div className="leading-none text-muted-foreground">
          <p>Showing total passwords created</p>
        </div>
      </CardFooter>
    </Card>
  );
